...
model0 <- lmer(SYS ~ AGE + DIA + FH123 + HAP + HRT + MNACT5 + STR + TIR + DAY + PHASE + POSTURE + time_c + (time_c)^2 + (1|SNUM), data = nursebp)
summary(model0)
...
model1 <- lmer(SYS ~ AGE + DIA + FH123 + HAP + HRT + MNACT5 + STR + TIR + DAY + PHASE + POSTURE + time_c + (time_c)^2 + (1+ time_c|SNUM), data = nursebp)
summary(model1)
```
3. Remove DIA
```{r}
model3 <- lmer(SYS ~ AGE + FH123 + HAP + HRT + MNACT5 + STR + TIR + DAY + PHASE + POSTURE + time_c + (time_c)^2 + (1 + time_c | SNUM), data = nursebp)
anova(model0, model3)
...
fit1 <- lme(SYS ~ AGE + DIA + FH123 + HAP + HRT + MNACT5 + STR + TIR + DAY + PHASE + POSTURE + time_c + (time_c)^2,random = ~time_c | SNUM,
...
```{r}
#exponential error
fit2 <- lme(SYS ~ AGE + DIA + FH123 + HAP + HRT + MNACT5 + STR + TIR + DAY + PHASE + POSTURE + time_c + (time_c)^2,random = ~time_c | SNUM,
...
fit3 <- lme(SYS ~ AGE + DIA + FH123 + HAP + HRT + MNACT5 + STR + TIR + DAY + PHASE + POSTURE + time_c + (time_c)^2 ,random = ~time_c | SNUM,
...
fit4 <- lme(SYS ~ AGE + DIA + FH123 + HAP + HRT + MNACT5 + STR + TIR + DAY + PHASE + POSTURE + time_c + (time_c)^2,random = ~time_c | SNUM,
